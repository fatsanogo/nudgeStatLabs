...
question("Does changing the number of bootstap samples affect the standard error? **Hint:** Remember that a 95% confidence interval is roughly our original estimate +/- 2*SE.",
    ...
    answer("No, the standard error stays roughly the same.",correct = TRUE),
    allow_retry = TRUE,
    random_answer_order = F
  )
```
...
4. (More Practice) Would we expect that proportion to get closer, further away, or stay roughly the same, if we had 200 students participating? Explain your answer.
