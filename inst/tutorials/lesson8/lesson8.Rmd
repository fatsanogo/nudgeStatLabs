...
4. (More practice) Assess the three assumptions needed to assess whether the linear model is reliable (the two models created in question 2). You should make 3 plots for each regression model recall the assumption are 1)Linearity checked using a scatterplot, 2)Nearly normal residual and 3) constant variability. Are the assumptions met? Explain why or why not.
